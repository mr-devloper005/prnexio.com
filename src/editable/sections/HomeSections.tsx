        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="signal-rise">
            ...
            <h1 className="mt-6 text-4xl font-extrabold leading-[1.04] tracking-[-0.035em] sm:text-5xl lg:text-6xl">
              {hero.title[0]} <span className="bg-[linear-gradient(120deg,#c9b6ff,#ff9d7e)] bg-clip-text text-transparent">{hero.title.slice(1).join(' ')}</span>
            </h1>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link href={hero.primaryCta.href} className="inline-flex items-center gap-2 rounded-full bg-[var(--slot4-accent-2)] px-7 py-3.5 text-sm font-bold text-white shadow-[0_14px_34px_rgba(255,106,61,0.3)] transition hover:-translate-y-0.5">
        ...
        <div className="signal-on-dark relative overflow-hidden rounded-[2rem] bg-[var(--slot4-dark-bg)] px-6 py-14 text-white sm:px-12 lg:px-16 lg:py-20" data-reveal>
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.3fr_0.7fr]">
            ...
            <div className="flex flex-col gap-3 lg:items-end">
              <Link href={cta.primaryCta.href} className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[var(--slot4-accent-2)] px-7 py-4 text-sm font-bold text-white shadow-[0_14px_34px_rgba(255,106,61,0.3)] transition hover:-translate-y-0.5 lg:w-auto">{cta.primaryCta.label} <ArrowRight className="h-4 w-4" /></Link>
