        ...
        <section className="signal-on-dark relative overflow-hidden bg-[var(--slot4-dark-bg)] text-white">
          ...
          <div className="relative mx-auto w-full max-w-[var(--editable-container)] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
            ...
            <div className="mt-8 flex flex-wrap gap-2.5">
              <Link href={basePath} className={`rounded-full px-4 py-2 text-sm font-bold transition ${category === 'all' ? 'bg-[var(--slot4-accent-2)] text-white' : 'bg-white/10 text-white/80 hover:bg-white/20'}`}>Latest</Link>
              {categories.slice(0, 8).map((item) => (
                <Link key={item.slug} href={pageHref(basePath, item.slug, 1)} className={`whitespace-nowrap rounded-full px-4 py-2 text-sm font-bold transition ${category === item.slug ? 'bg-[var(--slot4-accent-2)] text-white' : 'bg-white/10 text-white/80 hover:bg-white/20'}`}>{item.name}</Link>
              ))}
            </div>
          </div>
        </section>
          ...
          {lead ? (
            <div className="grid gap-6 lg:grid-cols-[1.6fr_0.9fr]">
              <Link href={`${basePath}/${lead.slug}`} data-reveal className="signal-zoom group relative block min-h-[26rem] overflow-hidden rounded-3xl bg-[var(--slot4-dark-bg)]">
                ...
                <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(16,12,40,0.1),rgba(16,12,40,0.92))]" />
