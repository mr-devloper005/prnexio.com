    ...
    <section className="bg-[var(--slot4-page-bg)]">
      ...
      {images[0] ? (
        <figure className="mx-auto -mt-8 w-full max-w-[1100px] px-4 sm:px-6 lg:px-8">
          <div className="signal-zoom overflow-hidden rounded-3xl border border-[var(--editable-border)] bg-white shadow-[0_30px_80px_rgba(26,19,64,0.16)]">
...
function RelatedPanel({ task, related, compact = false }: { task: TaskKey; post: SitePost; related: SitePost[]; compact?: boolean }) {
  ...
  return (
    <aside className="min-w-0 space-y-5 lg:sticky lg:top-24">
      {!compact ? (
        <div className="rounded-3xl border border-[var(--editable-border)] bg-[var(--detail-surface)] p-6 shadow-[0_14px_40px_rgba(26,19,64,0.08)]">
...
function EditableComments({ comments }: { slug: string; comments: Array<{ id: string; name: string; comment: string; createdAt: string }> }) {
  return (
    <section className="mt-12 rounded-3xl border border-[var(--editable-border)] bg-[var(--detail-surface)] p-6 shadow-[0_14px_40px_rgba(26,19,64,0.08)]">
