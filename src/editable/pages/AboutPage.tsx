            ...
            <div className="signal-on-dark relative overflow-hidden rounded-[2rem] bg-[var(--slot4-dark-bg)] px-6 py-14 text-white sm:px-12 lg:px-16" data-reveal>
              ...
              <div className="relative flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href="/search" className="inline-flex items-center gap-2 rounded-full bg-[var(--slot4-accent-2)] px-7 py-3.5 text-sm font-bold text-white transition hover:-translate-y-0.5">Explore coverage <ArrowRight className="h-4 w-4" /></Link>
