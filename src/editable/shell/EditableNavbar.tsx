...
export function EditableNavbar() {
  ...
  return (
    <header className={`sticky top-0 z-50 border-b border-[var(--editable-border)] backdrop-blur-xl transition-all duration-300 ${scrolled ? 'bg-white/90 shadow-[0_10px_30px_rgba(26,19,64,0.08)]' : 'bg-white/70'}`}>
      <div className={`mx-auto flex w-full max-w-[var(--editable-container)] items-center justify-between gap-4 px-4 transition-all duration-300 sm:px-6 lg:px-8 ${scrolled ? 'h-[64px]' : 'h-[78px]'}`}>
        <Link href="/" className="group flex items-center gap-2.5">
          <span className="flex h-10 w-10 items-center justify-center rounded-2xl text-white shadow-[0_10px_24px_rgba(91,52,232,0.32)] transition group-hover:-translate-y-0.5">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {session ? (
            <>
              ...
              <Link href="/create" className="hidden items-center gap-2 rounded-full bg-[var(--slot4-accent)] px-5 py-2.5 text-sm font-bold text-white shadow-[0_10px_24px_rgba(91,52,232,0.28)] transition hover:-translate-y-0.5 hover:bg-[var(--slot4-accent-strong)] sm:inline-flex">
            ...
            <>
              ...
              <Link href="/signup" className="inline-flex items-center rounded-full bg-[var(--slot4-accent)] px-5 py-2.5 text-sm font-bold text-white shadow-[0_10px_24px_rgba(91,52,232,0.28)] transition hover:-translate-y-0.5 hover:bg-[var(--slot4-accent-strong)]">Get started</Link>
            </>
          )}
