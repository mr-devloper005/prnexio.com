...
export function EditableContactLeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-8">
      ...
      <button type="submit" disabled={status === 'submitting'} className="mt-6 inline-flex h-[3.25rem] w-full items-center justify-center gap-2 rounded-full bg-[var(--slot4-accent)] px-6 text-sm font-bold tracking-[0.02em] text-white shadow-[0_12px_30px_rgba(91,52,232,0.28)] transition hover:-translate-y-0.5 hover:bg-[var(--slot4-accent-strong)] disabled:cursor-not-allowed disabled:opacity-70">
